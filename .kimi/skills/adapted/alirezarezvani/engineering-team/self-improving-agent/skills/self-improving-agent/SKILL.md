...
# [Plugin command removed - not available in Kimi] self-improving-agent@claude-code-skills
```
...
| `~/.claude/projects/<path>/memory/MEMORY.md` | the agent (auto) | Project learnings | First 200 lines |
| `~/.claude/projects/<path>/memory/*.md` | the agent (overflow) | Topic-specific notes | On demand |
...
- Ready for `# [Plugin command removed - not available in Kimi]` or `clawhub publish`
...
|----------|--------------|---------------|
| Kimi Code CLI | Auto-memory (MEMORY.md) | ✅ Full support |
...
- [Kimi Code CLI Memory Docs](https://code.claude.com/docs/en/memory)
