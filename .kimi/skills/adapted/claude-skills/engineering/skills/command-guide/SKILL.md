...
name: "command-guide"
description: >
  Kimi Code CLI Command Selection Guide - Automatically recommend and select the right
  commands, agents, and skills in Kimi Code CLI.
...
# Kimi Code CLI Command Selection Guide
