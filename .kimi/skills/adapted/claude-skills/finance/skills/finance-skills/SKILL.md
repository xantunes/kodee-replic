...
---
name: "finance-skills"
description: "Financial analyst agent skill and plugin for Kimi Code CLI, Codex, Gemini CLI, Cursor, OpenClaw. Ratio analysis, DCF valuation, budget variance, rolling forecasts. 4 Python tools (stdlib-only)."
version: 1.0.0
