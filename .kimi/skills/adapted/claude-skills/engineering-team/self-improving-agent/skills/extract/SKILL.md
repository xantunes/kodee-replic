...
For skills about Kimi Code CLI itself, use the `cc-` prefix instead:
...
- [ ] `name` does NOT contain reserved fragments `claude` or `anthropic` (use `cc-` prefix for Kimi Code CLI skills)
...
Install: # [Plugin command removed - not available in Kimi] (copy to your skills directory)
