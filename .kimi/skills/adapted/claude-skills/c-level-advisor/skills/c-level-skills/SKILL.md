...
description: "10 C-level advisory agent skills and plugins for Kimi Code CLI, Codex, Gemini CLI, Cursor, OpenClaw. CEO, CTO, COO, CPO, CMO, CFO, CRO, CISO, CHRO, Executive Mentor. Multi-role board meetings, strategy routing, structured recommendations. For founders needing executive-level decision support."
license: MIT
metadata:
  version: 2.0.0
