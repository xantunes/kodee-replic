...
One skill for everything about your project's Kimi Code CLI configuration. Run it at the start, middle, or end of a project — it figures out what's needed.
...
**Discover installed skills**: The skill will load automatically or ToolSearch to list available skills.
