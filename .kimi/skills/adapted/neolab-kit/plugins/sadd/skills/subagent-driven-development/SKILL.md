...
Read plan file, create SetTodoList with all tasks.

### 2. Execute Task with Subagent

For each task:

**Use Agent tool with subagent_type to dispatch fresh:**
...
**Use Agent tool with subagent_type to dispatch code-reviewer:**
...
**Use Agent tool with subagent_type to dispatch follow-up if needed:**
...
- Mark task as completed in SetTodoList
- Move to next task
- Repeat steps 2-5
...
[Load plan, create SetTodoList]

Task 1: Hook installation script

[Use Agent tool with subagent_type to dispatch implementation]
...
[Use Agent tool with subagent_type to dispatch fix]
