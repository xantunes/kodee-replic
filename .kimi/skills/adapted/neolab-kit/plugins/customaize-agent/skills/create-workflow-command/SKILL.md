...
|------------|-----------|-------|
| ReadFile tool | ✅ Yes | Can read any file |
| WriteFile tool | ✅ Yes | If not restricted |
...
Sub-agent will use ReadFile tool to fetch the file content.
...
| `model` | Specific the agent model (sonnet, opus, haiku) | Inherits from conversation |
...
allowed-tools: Task, Read, SetTodoList
model: sonnet
---
...
Create SetTodoList with workflow steps.
