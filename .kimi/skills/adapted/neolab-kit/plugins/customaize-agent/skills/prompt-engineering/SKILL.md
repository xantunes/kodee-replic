...
- 200K token capacity: The total available context window (200,000 tokens) represents the maximum capacity for storing conversation history and generating new output from the agent.
...
The context window is a public good. Your prompt, command, skill shares the context window with everything else the agent needs to know, including:
...
Usefull for writing prompts, including but not limited to: commands, hooks, skills for Kimi Code CLI, or prompts for sub agents or any other LLM interaction.
