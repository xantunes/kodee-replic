...
description: Evaluate and improve Kimi Code CLI commands, skills, and agents. Use when testing prompt effectiveness, validating context engineering choices, or measuring improvement quality.
---

# Evaluation Methods for Kimi Code CLI Agents
...
Implications for Kimi Code CLI development:
...
```markdown
You are evaluating the output of a Kimi Code CLI agent.
...
For Kimi Code CLI development, ask users this:
...
When iterating on Kimi Code CLI prompts, evaluate systematically:
...
## Example: Evaluating a Kimi Code CLI Command
...
- the agent shows similar patterns
...
# LLM-as-Judge Implementation Patterns for Kimi Code CLI

This reference provides practical prompt patterns and workflows for evaluating Kimi Code CLI commands, skills, and agents during development.
...
```markdown
You are evaluating the output of a Kimi Code CLI command.
...
## Evaluation Workflows for Kimi Code CLI Development
