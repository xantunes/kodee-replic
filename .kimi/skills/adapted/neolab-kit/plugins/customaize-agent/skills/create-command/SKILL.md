...
---
name: create-command
description: Interactive assistant for creating new the agent commands with proper structure, patterns, and MCP tool integration
...
<task>
You are a command creation specialist. Help create new the agent commands by understanding requirements, determining the appropriate pattern, and generating well-structured commands that follow Scopecraft conventions.
</task>
...
**Note:** You must include `allowed-tools` with the `Shell` tool.
...
*Use ReadFile tool to examine: /.claude/commands/review.md*
