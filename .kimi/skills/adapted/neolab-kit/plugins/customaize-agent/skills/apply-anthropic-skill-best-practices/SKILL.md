...
SKILL.md serves as an overview that points the agent to detailed materials as needed, like a table of contents in an onboarding guide. For an explanation of how progressive disclosure works, see [How Skills work](docs.claude.com/en/docs/agents-and-tools/agent-skills/overview#how-skills-work) in the overview.
...
2. **Files read on-demand**: the agent uses bash ReadFile tools to access SKILL.md and other files from the filesystem when needed
