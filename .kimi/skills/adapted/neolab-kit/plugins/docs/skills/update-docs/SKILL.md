...
<context>
References:
- Tech Writer Agent: @# [Plugin command - not available in Kimi]s/sdd/agents/tech-writer.md  
...
1. Read Tech Writer Agent guidelines from @# [Plugin command - not available in Kimi]s/sdd/agents/tech-writer.md
...
8. **Launch `sdd:tech-writer` agents for documentation (parallel)** (Sonnet or Opus models)
   ...
   - Provide each agent with:
     ...
     - **Guidance**: Read Tech Writer Agent @# [Plugin command - not available in Kimi]s/sdd/agents/tech-writer.md for best practices
...
Your task:
1. Read Tech Writer Agent guidelines @# [Plugin command - not available in Kimi]s/sdd/agents/tech-writer.md
